<x-layouts.app>
    <div class="max-w-2xl mx-auto">
        <!-- Header -->
        <div class="mb-8">
            <a href="{{ route('softwares.show', $software) }}" class="text-blue-600 hover:text-blue-700 flex items-center gap-1 mb-4">
            ...
            <p class="text-gray-600 mt-2">Update application information</p>
        </div>

        <!-- Form Card -->
        <div class="bg-white rounded-lg shadow p-8">
            <form action="{{ route('softwares.update', $software) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input 
                        ...
                        id="monthly_cost" 
                        name="monthly_cost" 
                        value="{{ old('monthly_cost', $software->monthly_cost) }}"
                        placeholder="0.00"
                        step="0.01"
                        min="0"
                ...
                <div>
                    ...
                    >
                        ...
                        <option value="low" {{ old('risk_level', $software->risk_level) === 'low' ? 'selected' : '' }}>Low Risk</option>
                        <option value="high" {{ old('risk_level', $software->risk_level) === 'high' ? 'selected' : '' }}>High Risk</option>
                    </select>
                ...
                <div>
                    ...
                    <input 
                        ...
                        id="website_url" 
                        name="website_url" 
                        value="{{ old('website_url', $software->website_url) }}"
                ...
                <div class="flex gap-4 pt-6 border-t border-gray-200">
                    ...
                    <a 
                        href="{{ route('softwares.show', $software) }}" 
