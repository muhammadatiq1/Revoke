...
<head>
    ...
    <title>Revoke - Sign In</title>

    @vite(['resources/css/app.css', 'resources/js/app.js'])
</head>
<body class="font-sans antialiased bg-gray-50 h-screen flex items-center justify-center overflow-hidden" x-data="{ showPassword: false }">
    <div class="w-full max-w-md mx-auto px-4">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-900 to-blue-800 px-8 py-12 text-center">
                ...
                <p class="text-blue-100 text-sm font-medium">Sign in to Revoke Shadow IT System</p>
            </div>
            ...
            <div class="px-8 py-8">
                    ...
                    <div class="flex items-center justify-between pt-1">
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input 
                                ...
                                name="remember" 
                                id="remember"
                                class="w-4 h-4 rounded border border-gray-300 text-blue-600 focus:ring-0 cursor-pointer accent-blue-600"
                            >
                            <span class="text-xs text-gray-600 font-medium">Remember me</span>
                        </label>
                        <a href="#" class="text-xs text-blue-600 hover:text-blue-700 font-semibold transition-colors duration-300">Forgot Password?</a>
                    </div>
                ...
                <div class="mt-6 text-center border-t border-gray-200 pt-6">
                    <p class="text-gray-600 text-xs font-medium">
                        ...
                        <a href="{{ route('register') }}" class="text-blue-600 hover:text-blue-700 font-bold transition-colors duration-300">
                            Sign up here
                        </a>
                    </p>
                </div>
